...
public class CarpetTCTCAdditionSettings
{
    ...
    @Rule(
        desc = "Enables /loadchunk command.",
        extra = "Loads a chunk remotely",
        category = {"TCTC", RuleCategory.COMMAND, RuleCategory.CREATIVE, RuleCategory.EXPERIMENTAL},
        options = {"true", "false", "ops", "0", "1", "2", "3", "4"}
    )
    public static String commandLoadChunk = "ops";
