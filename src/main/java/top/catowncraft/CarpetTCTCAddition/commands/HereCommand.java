...
public class HereCommand {
        ...
        if (serverPlayer.level.dimension() == Level.OVERWORLD || serverPlayer.level.dimension() == Level.NETHER) {
            MessageUtil.sendServerMessage(CarpetTCTCAddition.getServer(),
                    new TranslatableComponent(tr("carpet-tctc-addition.message.command.here.withTransformed", "%s @ %s %s %s %s %s %s -> %s"),
                            ...
                            getDimension(serverPlayer.level.dimension()),
                            new TextComponent(getOriginalPosition(serverPlayer)).withStyle(serverPlayer.level.dimension() == Level.OVERWORLD ? ChatFormatting.DARK_GREEN : ChatFormatting.DARK_RED),
                            ...
                            new TextComponent(serverPlayer.level.dimension() == Level.OVERWORLD ? getDividedPosition(serverPlayer) : getMultipliedPosition(serverPlayer)).withStyle(serverPlayer.level.dimension() == Level.OVERWORLD ? ChatFormatting.DARK_RED : ChatFormatting.DARK_GREEN)
            ...
            MessageUtil.sendServerMessage(CarpetTCTCAddition.getServer(),
                    new TranslatableComponent(tr("carpet-tctc-addition.message.command.here.withoutTransformed", "%s @ %s %s %s %s %s %s"),
                            new TextComponent(serverPlayer.getName().getString()).withStyle(ChatFormatting.GRAY),
                            getDimension(serverPlayer.level.dimension()),
                            new TextComponent(getOriginalPosition(serverPlayer)).withStyle(serverPlayer.level.dimension() == Level.END ? ChatFormatting.GOLD : ChatFormatting.DARK_AQUA),
                            getWorldMapAdderVM(serverPlayer),
                            getWorldMapAdderXM(serverPlayer),
                            getTeleportLocationAction(serverPlayer),
                            getTeleportPlayerAction(serverPlayer)
    ...
    public static Component getWorldMapAdderVM(Entity entity) {
        return new TextComponent("[V]").withStyle(ChatFormatting.DARK_BLUE).copy().withStyle((style -> style.withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, String.format("/newWaypoint x:%d, y:%d, z:%d", (int) entity.getX(), (int) entity.getY(), (int) entity.getZ()))).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TextComponent(tr("carpet-tctc-addition.message.command.here.hover.voxelMap", "Click with VoxelMap to highlight this coordinate. Ctrl-Click with VoxelMap to add waypoints."))))));
    }

    public static Component getWorldMapAdderXM(Entity entity) {
        return new TextComponent("[X]").withStyle(ChatFormatting.DARK_GREEN).copy().withStyle((style -> style.withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, String.format("xaero_waypoint_add:%s's Location:%s:%d:%d:%d:8:false:0", entity.getDisplayName().getString(), entity.getDisplayName().getString(1), (int) entity.getX(), (int) entity.getY(), (int) entity.getZ()))).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TextComponent(tr("carpet-tctc-addition.message.command.here.hover.xaeroMap", "Click with xaeroMap to add waypoints."))))));
    }

    public static Component getTeleportLocationAction(Entity entity) {
        return new TextComponent("[T]").withStyle(ChatFormatting.DARK_PURPLE).copy().withStyle((style -> style.withClickEvent(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, String.format("/execute in %s run tp %d %d %d", entity.level.dimension().location().toString(), (int) entity.getX(), (int) entity.getY(), (int) entity.getZ()))).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TextComponent(String.format(tr("carpet-tctc-addition.message.command.here.hover.teleport.location", "Click teleport to [%d, %d, %d]."), (int) entity.getX(), (int) entity.getY(), (int) entity.getZ()))))));
    }

    public static Component getTeleportPlayerAction(Entity entity) {
        return new TextComponent("[P]").withStyle(ChatFormatting.DARK_AQUA).copy().withStyle((style -> style.withClickEvent(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, String.format("/tp %s", entity.getName().getString()))).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TextComponent(String.format(tr("carpet-tctc-addition.message.command.here.hover.teleport.player", "Click teleport to %s."), entity.getName().getString()))))));
    }
}