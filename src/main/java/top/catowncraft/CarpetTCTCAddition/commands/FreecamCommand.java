...
public class FreecamCommand {
    ...
    public static int executeFreeCamera(CommandSourceStack source, ServerPlayer serverPlayer) {
        ...
        FreeCameraUtil.CameraData cameraDataNew = new FreeCameraUtil.CameraData(serverPlayer.gameMode.getGameModeForPlayer(), serverPlayer.getLevel().dimension(), serverPlayer.getX(), serverPlayer.getY(), serverPlayer.getZ(), serverPlayer.yRot, serverPlayer.xRot, true);
