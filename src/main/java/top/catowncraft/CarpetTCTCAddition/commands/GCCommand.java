...
public class GCCommand {
    ...
    static class CleanerThread implements Runnable {
        ...
        @Override
        public void run() {
            MessageUtil.sendMessage(this.sourceStack, tr("carpet-tctc-addition.message.command.gc.started", "Memory cleaner thread started!"));
            System.gc();
            try {
                Thread.sleep(1000L);
            ...
            System.gc();
            MessageUtil.sendMessage(this.sourceStack, tr("carpet-tctc-addition.message.command.gc.finished", "Memory cleaner thread finished!"));
        }
    }
}
